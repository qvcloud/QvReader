...
console.log('Running Release Provenance Contract Tests...');
...
// 2. Missing Platform Fixture (Missing Linux)
...
console.log('✔ Missing platform fixture rejected as expected');

// 3. Mismatched Version Fixture (Tag v0.2.1 vs version 0.2.0)
...
console.log('✔ Mismatched version fixture rejected as expected');

// 4. Invalid SHA Fixture (sha256 is not 64 hex chars)
...
console.log('✔ Invalid SHA fixture rejected as expected');

// 5. Duplicate Artifact Fixture (Same artifact name repeated)
...
console.log('✔ Duplicate artifact fixture rejected as expected');

console.log('\nAll Release Provenance Contract Tests Passed Successfully! (5/5)');
